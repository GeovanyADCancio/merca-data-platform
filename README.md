# Ingestão Batch — Ecommerce Categorias

## Objetivo

Este notebook tem como objetivo realizar a ingestão batch do arquivo `ecommerce_categorias.csv`, disponível no Azure Data Lake, validando sua estrutura antes da gravação no banco de dados SQL Server.
